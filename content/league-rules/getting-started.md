...
**What does 500 points cost?** Typically one Combat Patrol box (~$170) covers it, often with room to grow into phase 2. 

**Are 3d printed models and proxies ok?** Yes, but support your FLGS whenever you can!

**What else do I need?** Dice, a tape measure, glue, clippers. The store stocks all of it.

**What if I lose every game?** You still score league points every game, painting scores points, and everyone's first league is a losing league. The real goal is to trick yourself into having a painted army at the end of the league, so winning isn't what's important.
